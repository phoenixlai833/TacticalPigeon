"use strict";
(self["webpackChunktactical_people"] = self["webpackChunktactical_people"] || []).push([[11],{
...
function changeRoundTitle(roundCounter) {
  roundTitle.innerHTML = "<span>Round ".concat(roundCounter, "</span>");
  roundTitle.classList.add("animate__bounceInDown");
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (changeRoundTitle);
...
function _roundCountdown() {
  _roundCountdown = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var wait, _wait, _i, _arr, item, _i2, _arr2, _item;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (roundCountdown);
